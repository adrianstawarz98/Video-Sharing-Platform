...
class __TwigTemplate_6e2d961a4bae47dc685e31a27dd37f287a6f953908ef037c70dc2c182b154b4c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "        <div class=\"h3 mb-3 font-weight-normal text-primary\">
...
\t\t<input type=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Email address\" name=\"_email\" required autofocus>
...
\t</form>
    ";
        ...
        // line 35
        echo "    <p class=\"mt-5 mb-3 text-muted\">&copy; 2017-2018
\t<a href=\"";
        // line 36
...
";
    ...
    {
        return array (  179 => 39,  166 => 36,  163 => 35,  149 => 24,  140 => 18,  137 => 17,  135 => 16,  127 => 13,  124 => 12,  121 => 11,  115 => 9,  112 => 8,  102 => 7,  84 => 6,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% block main %}
    ...
    {% endif %}
    {% if app.user %}
        <div class=\"h3 mb-3 font-weight-normal text-primary\">
            You are logged in as {{ app.user.username }} <br><a href=\"{{ path('logout') }}\">Logout</a>
        </div>
    {% endif %}
{% if not app.user %}
...
\t<a href=\"{{path('main_page')}}\">Main Page</a>
\t</p>
{% endblock %}
{% block footer_links %}{% endblock %}
", "front/login.html.twig", "E:\\Video-Sharing-Platform\\templates\\front\\login.html.twig");
    }
}
