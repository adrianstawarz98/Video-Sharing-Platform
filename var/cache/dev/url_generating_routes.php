...
return [
    ...
    'edit_category' => [['id'], ['_controller' => 'App\\Controller\\AdminController::editCategory'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/edit-category']], [], []],
    ...
    'video_list' => [['category', 'id'], ['_controller' => 'App\\Controller\\FrontController::videoList'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'category', true], ['text', '/video-list']], [], []],
